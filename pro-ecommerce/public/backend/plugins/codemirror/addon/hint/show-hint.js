...
(function(mod) {
    ...
    var ACTIVE_frT_ELEMENT_CLASS = "CodeMirror-hint-active";
    ...
    function Widget(completion, data) {
        ...
        for (var i = 0; i < completions.length; ++i) {
            var elt = hints.appendChild(ownerDocument.createElement("li")),
                cur = completions[i];
            var className = HINT_ELEMENT_CLASS + (i != this.selectedHint ? "" : " " + ACTIVE_frT_ELEMENT_CLASS);
    ...
    Widget.prototype = {
        ...
        changeActive: function(i, avoidWrap) {
            ...
            if (node) node.className = node.className.replace(" " + ACTIVE_frT_ELEMENT_CLASS, "");
            node = this.hints.childNodes[this.selectedHint = i];
            node.className += " " + ACTIVE_frT_ELEMENT_CLASS;
            this.scrollToActive()
