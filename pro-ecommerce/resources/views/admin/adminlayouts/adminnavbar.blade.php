<nav class="main-header navbar navbar-expand navbar-dark text-sm">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/' )}}" target="__blank" class="nav-link"><i class="fas fa-globe text-info"></i> e-commerce</a>
      </li>
    </ul>
      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          ...
          <li class="user-footer">
            <a href="#" class="btn btn-sm btn-outline-dark">Mon Profil</a>
            <a href="{{ route('admin.logout') }}" class="btn btn-sm btn-outline-danger float-right">Se déconnecter</a>
          </li>
        </ul>
      </li>
      {{-- <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header bg-info">Espace Personel</span>
          <div class="dropdown-divider"></div>
          ...
          <div class="dropdown-divider"></div>
          <a href="{{ route('admin.logout') }}" class="dropdown-item dropdown-footer bg-light"><i class="fas fa-sign-out-alt"></i> <strong>Se déconnecter</strong>
            </a>
        </div>
      </li> --}}
    </ul>
