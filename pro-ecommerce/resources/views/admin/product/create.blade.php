      ...
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-2">
              ...
              <a href="{{ route('all.product' )}}" class="btn btn-info float-right">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="brand_id" style="width: 100%;">
                                                    ...
                                                    @foreach($brand as $br)
                                                    <option value="{{ $br->id }}">{{ $br->brand_name_fr }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_name_fr" class="form-control" id="brandInputNameFR" required placeholder="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_name_en" class="form-control" id="brandInputNameEN" required placeholder="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_code" class="form-control" id="codeProductInputName" required placeholder="">
                                                @error('product_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_qty" class="form-control" id="productQTYInputName" required placeholder="">
                                                @error('product_qty')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="selling_price" class="form-control" id="sellingPriceInput" required placeholder="">
                                            </div>
                                            @error('selling_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="discount_price" class="form-control" id="discountPriceInput" required placeholder="">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_fr" class="form-control" value="" data-role="tagsinput">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_size_fr" class="form-control" id="productSizeInputNameFR" data-role="tagsinput" placeholder="">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_size_en" class="form-control" id="productSizeInputNameEN" data-role="tagsinput" placeholder="">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_color_fr" class="form-control" id="productColorInputNameFR" data-role="tagsinput" required placeholder="">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_color_en" class="form-control" id="productColorInputNameEN" data-role="tagsinput" required placeholder="">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_descp_fr" id="textarea" class="form-control" required placeholder="Brève description du Produit en français..."></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Brève description du Produit en anglais..."></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernoteFR" name="product_detail_fr">
                                                    Description <em>détaillée</em> <u>du produit</u> <strong>en français...</strong>
                                                </textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernoteEN" name="product_detail_en">
                                                    Description <em>détaillée</em> <u>du produit</u> <strong>en anglais...</strong>
                                                </textarea>
