...
<div id="page-content">
    ...
    <div class="page section-header text-center mb-0">
        <div class="page-title">
            <div class="wrapper"><h1 class="page-width"><i class="fa fa-list-alt"></i> Collection Items</h1></div>
          </div>
    </div>
    <!--End Page Title-->
    <div class="bredcrumbWrap">
        <div class="container breadcrumbs">
            <a href="{{url('/')}}" title="Back to the home page">Accueil</a><span aria-hidden="true">›</span><span>Collection Items</span>
        </div>
    </div>
    <div class="container">
        <div class="row">
