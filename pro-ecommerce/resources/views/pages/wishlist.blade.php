...
<div id="page-content">
    ...
    <div class="page section-header text-center mb-0">
        <div class="page-title">
            <div class="wrapper"><h1 class="page-width"><i class="fa fa-heart"></i> Mes Favoris</h1></div>
          </div>
    </div>
    <!--End Page Title-->
                ...
                <form action="#">
                    <div class="wishlist-table table-content table-responsive">
                        <table class="table table-bordered">
                            {{-- <thead style="background-color: #01bad4; color: #fff;"> --}}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-thumbnail text-center">
                                        <a href="#"><img src="frontend/images/product-images/product-image8.jpg" alt="" title="" /></a>
                                    </td>
                                ...
                                <tr>
                                    <td class="product-remove text-center" valign="middle"><a href="#"><i class="icon icon anm anm-times-l"></i></a></td>
                                    <td class="product-thumbnail text-center">
                                        <a href="#"><img src="frontend/images/product-images/product-image4.jpg" alt="" title="" /></a>
                                    </td>
                                ...
                                <tr>
                                    <td class="product-remove text-center" valign="middle"><a href="#"><i class="icon icon anm anm-times-l"></i></a></td>
                                    <td class="product-thumbnail text-center">
                                        <a href="#"><img src="frontend/images/product-images/product-image5.jpg" alt="" title="" /></a>
                                    </td>
