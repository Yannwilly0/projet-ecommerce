...
<div id="page-content">
    ...
    <div class="page section-header text-center mb-0">
        <div class="page-title">
            <div class="wrapper"><h1 class="page-width"><i class="fa fa-list-alt"></i> Dernières Nouveautés</h1></div>
          </div>
    </div>
    <!--End Page Title-->
    <div class="bredcrumbWrap">
        <div class="container breadcrumbs">
            <a href="{{url('/')}}" title="Back to the home page">Accueil</a><span aria-hidden="true">›</span><span>Dernières Nouveautés</span>
        </div>
    </div>
    <div class="container">
        <div class="row">
                        ...
                        <div class="widget-content">
                            <ul class="sidebar_categories">
                                ...
                                <li class="level1 sub-level"><a href="#;" class="site-nav">Test</a>
                                    <ul class="sublinks">
                                        <li class="level2 sub-level"><a href="#;" class="site-nav">Sub-Test</a>
                                            <ul class="sublinks">
                                                <li class="level3"><a href="#;" class="site-nav">Sub Sub-Test</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
