...
<div id="page-content">
    ...
    <div class="page section-header text-center mb-0">
        <div class="page-title">
            <div class="wrapper"><h1 class="page-width"><i class="fa fa-shopping-cart"></i> Commander</h1></div>
          </div>
    </div>
    <!--End Page Title-->
    <div class="bredcrumbWrap">
        <div class="container breadcrumbs">
            <a href="{{url('/')}}" title="Back to the home page">Accueil</a>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                <div class="customer-box returning-customer">
                    <h3><i class="icon anm anm-user-al"></i> Déjà client? <a href="#customer-login" id="customer" class="text-white text-decoration-underline" data-toggle="collapse">Cliquez ici pour vous identifier</a></h3>
                    <div id="customer-login" class="collapse customer-content">
                        <div class="customer-info">
                            <p class="coupon-text">Si vous avez déjà acheté chez nous, veuillez entrer vos coordonnées dans les cases ci-dessous. Si vous êtes un nouveau client, veuillez passer à la facturation &amp; Section d'expédition.</p>
                            <form>
                                <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                <div class="customer-box customer-coupon">
                    <h3 class="font-15 xs-font-13"><i class="icon anm anm-gift-l"></i> Avez-vous un coupon? <a href="#have-coupon" class="text-white text-decoration-underline" data-toggle="collapse">Cliquez pour entrer votre code</a></h3>
                    <div id="have-coupon" class="collapse coupon-checkout-content">
                        <div class="discount-coupon">
                            <div id="coupon" class="coupon-dec tab-pane active">
                                <p class="margin-10px-bottom">Entrez votre code promo si vous en avez un.</p>
                    ...
                    <div class="your-payment">
                        ...
                        <div class="payment-method">
                                            ...
                                            <div class="card-body">
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                            <img class="padding-25px-top xs-padding-5px-top" src="frontend/images/payment-img.jpg" alt="card" title="card" />
                                                        </div>
                                                    </div>
                                                </fieldset>
                            ...
                            <div class="order-button-payment">
                                <button class="btn" value="Place order" type="submit">Passer la commande</button>
                            </div>
                        </div>
                    </div>
                </div>
